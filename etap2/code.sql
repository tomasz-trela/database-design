...
CREATE TABLE IF NOT EXISTS "invoice" (
	"id" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"invoice_number" INVOICE_STATUS NOT NULL UNIQUE,
	"status" ORDER_STATUS NOT NULL,
...
CREATE TABLE IF NOT EXISTS "allergen_customer" (
	"allergen_customer_id" INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "allergen_ingredient" (
	"allergen_ingredient_id" INTEGER NOT NULL,
	"allergen_id" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"ingredient_id" INTEGER NOT NULL,
...
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "cook"
ADD FOREIGN KEY("cook_id") REFERENCES "user"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "courier"
ADD FOREIGN KEY("courier_id") REFERENCES "user"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "cook"
ADD FOREIGN KEY("cook_id") REFERENCES "order_item_fulfillment"("cook_id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "courier"
ADD FOREIGN KEY("courier_id") REFERENCES "order_item_delivery"("courier_id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "courier_types"
ADD FOREIGN KEY("courier_type_id") REFERENCES "courier_types"("courier_type_id")
ON UPDATE NO ACTION ON DELETE NO ACTION;