...
CREATE TABLE IF NOT EXISTS "ingredient" (
	...
	"description" TEXT,
	"calories_100g" INTEGER NOT NULL,
	"unit_of_measure" UNIT_OF_MEASUREMENT NOT NULL,
	"protein_100g" REAL NOT NULL,
	"fat_100g" REAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS "daily_menu_item" (
	"daily_menu_item_id" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
...
ADD FOREIGN KEY("meal_plan_day_id") REFERENCES "meal_plan_day"("meal_plan_day_id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "meal_plan_item"
ADD FOREIGN KEY("course_id") REFERENCES "course"("course_id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
...
-- ============ DAILY_MENU============
ALTER TABLE "daily_menu"
ADD CONSTRAINT uq_daily_menu_unique_date
  UNIQUE(menu_date);

-- ============ DAILY_MENU_ITEM ============
ALTER TABLE "daily_menu_item"
ADD CONSTRAINT uq_daily_menu_item_sequence_per_menu
  UNIQUE (menu_id, sequence),
ADD CONSTRAINT chk_daily_menu_item_sequence_positive
  CHECK (sequence > 0);
...
-- ============ COMPLAINT ============
ALTER TABLE "complaint"
ADD CONSTRAINT chk_complaint_refund_amount
...
ADD CONSTRAINT chk_complaint_refund_status_consistency
  CHECK (
    (refund_amount IS NULL)
    OR (status = 'positively resolved')
  );
...
-- ============ MEAL_PLAN_DAY ============
ALTER TABLE "meal_plan_day"
ADD CONSTRAINT chk_meal_plan_day_number_positive
  CHECK (day_number > 0),
ADD CONSTRAINT uq_meal_plan_day_unique
  UNIQUE (meal_plan_id, day_number);

-- ============ MEAL_PLAN_ITEM ============
ALTER TABLE "meal_plan_item"
ADD CONSTRAINT  uq_meal_plan_item_course_per_day
  UNIQUE (meal_plan_day_id, course_id),
ADD CONSTRAINT uq_meal_plan_item_sequence_per_day
  UNIQUE (meal_plan_day_id, sequence),
ADD CONSTRAINT chk_meal_plan_item_sequence_positive
  CHECK (sequence > 0);
